...
public class IntegralSequence{
  ...
  public IntegralSequence(RegularSequence sequence) {
    ...
    RegularSequence paddedSequence = sequence.padImage(padding); // Pad the image
  ...
  /**
   * Computes the integral image. In order to avoid border effects, 
   * the image is firstly periodized by padding the image and mirroring on 
   * image borders.
   * @param paddedSequence  Padded sequence
   */
